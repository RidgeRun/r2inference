...
#include <r2i/tensorrt/frameworkfactory.h>
...
TEST_GROUP (TensorRTFrameworkFactory) {
};

TEST (TensorRTFrameworkFactory, ValidFactory) {
  ...
  /* Is this a valid TensorRT factory? */
  auto ufactory =
    std::dynamic_pointer_cast<r2i::tensorrt::FrameworkFactory, r2i::IFrameworkFactory>
    (factory);
  ...
  LONGS_EQUAL (r2i::RuntimeError::Code::EOK, error.GetCode ());
  auto uloader =
    std::dynamic_pointer_cast<r2i::tensorrt::Loader, r2i::ILoader> (loader);
  ...
  LONGS_EQUAL (r2i::RuntimeError::Code::EOK, error.GetCode ());
  auto uengine =
    std::dynamic_pointer_cast<r2i::tensorrt::Engine, r2i::IEngine> (engine);
  ...
  LONGS_EQUAL (r2i::RuntimeError::Code::EOK, error.GetCode ());
  auto uparameters =
    std::dynamic_pointer_cast<r2i::tensorrt::Parameters, r2i::IParameters>
    (parameters);
  ...
  LONGS_EQUAL (r2i::RuntimeError::Code::EOK, error.GetCode ());
  auto uframe = std::dynamic_pointer_cast<r2i::tensorrt::Frame, r2i::IFrame>
                (frame);
