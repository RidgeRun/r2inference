...
static const float reference_matrix_resnet50v1[FRAME_SIZE] = {
  -123.680000, -115.779999, -101.940002, -120.680000, -112.779999, -98.940002,
    -117.680000, -109.779999, -95.940002, -114.680000, -106.779999, -92.940002
  };
...
TEST_GROUP(NormalizeResnet50V1) {
  r2i::RuntimeError error;
...
TEST(NormalizeResnet50V1, ApplySuccess) {
